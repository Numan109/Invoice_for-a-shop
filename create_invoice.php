                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <table class="table table-condensed table-striped" id="invoiceItem">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select id="product_name_1" name="product_name" class="form-control product_id" autocomplete="off" onchange="changeFunction(this,1)">
                                        ...
                                        <td>
                                            <select id="model_1" name="model" class="form-control">
    ...
    $(document).ready(function() {
        ...
        $("#addRows").click(function() {
            ...
            html = html +  `<tr>
                    <td>
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="itemRow custom-control-input" id="itemRow_${x}">
                            <label class="custom-control-label" for="itemRow_${x}"></label>
                        </div>
                    </td>
                    <td>
                        <select id="product_name_${x}" name="product_name" class="form-control product_id" autocomplete="off" onchange="changeFunction(this,${x})">
                            <option value="" selected disabled> Seclect product</option>
                            <option value="refrigerator">Refrigerator</option>
                            <option value="telivision">Telivision</option>
                            <option value="rice_cooker">Rice cooker</option>
                    ...
                    <td>
                        <select id="model_${x}" name="model" class="form-control model">
                            <option value="" selected disabled> Seclect Model</option>
                        </select>
                    </td>
                    <td><input type="text" name="p_sl_no[]" id="p_sl_no" class="form-control" autocomplete="off"></td>
        ...
        $("#invoiceItem").on('click','#removeRows',function() {
...
<script>
   function changeFunction(val,id)
   {
       console.log(id);
       return false;
    var products = document.querySelector(".product_id").value;
